...
const stubTpl = readFileSync('src/stub_template.css', 'utf8');
...
for (const v of variants) {
  ...
  writeFileSync(`mastodon/app/javascript/styles/${v.scssDir}.scss`, stubTpl.replaceAll(`{{scss_dir}}`, v.scssDir));
